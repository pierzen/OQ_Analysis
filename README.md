...
- [OQ_Analysis_Table_Ways_Topology.sql](sql/OQ_Analysis_Table_Ways_Topology.sql) Main Script for Topology Analysis - Adds table ways_topology with Warnings and error flags.
- [OQ_Building_Analysis.sql](sql/OQ_Building_Analysis.sql)
...
- [OQ_Topology_Intersect_Analysis.sql](sql/OQ_Topology_Intersect_Analysis.sql) Topological Analysis detects Polygons Intersects.
